...
const ISLAND_PALETTES = {
  thriving: {
    ...
    G: '#7a6856',                              // volcano crater — dormant (cool rock)
    '|': '#3f8577', '+': '#1b4a43',
    p: '#C63F3E', P: '#EAE4DA',
    A: '#b3e5ed', a: '#5ab3c0',               // water fringe — clear bright
  },
  healthy: {
    ...
    G: '#9a6030',                              // volcano crater — warm rock
    '|': '#8eb2aa', '+': '#3f8577',
    p: '#C63F3E', P: '#EAE4DA',
    A: '#a0d4de', a: '#4896a2',               // water fringe — medium teal
  },
  sick: {
    ...
    G: '#cc5518',                              // volcano crater — hot glowing
    '|': '#a8a07a', '+': '#6a5a3a',
    p: '#a85234', P: '#d8c08a',
    A: '#8cbbc6', a: '#3d7e8a',               // water fringe — murky
  },
  critical: {
    ...
    G: '#ff6600',                              // volcano crater — erupting lava!
    '|': '#6a6850', '+': '#38342a',
    p: '#7a3a3a', P: '#a89868',
    A: '#6e9098', a: '#2e636a',               // water fringe — dark murky
  },
};
